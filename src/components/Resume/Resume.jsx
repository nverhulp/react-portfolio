...
function Resume() {
  ...
  return (
    <>
        <p className='my-2 text-center'>You can also view and download my resume on <a href='https://drive.google.com/file/d/1tXWG6heLGfynYjTAaVqNnBYuwwtRsZWZ/view?usp=sharing' target={"_blank"} rel="noreferrer">Google Drive</a>.</p>
